public class vierZeichenketten {
    public static void main(String[] args) {
        ...
        System.out.println(vorname+nachname); // Gibt den vollen Namen ohne Leerzeichen aus
        System.out.println(vorname + " " + nachname); // Gibt den vollen Namen aus mit Leerzeichen aus
